...
class TestMain
{
	...
	public function new()
	{
		...
		#if MCOVER
			var client = AdaptiveLearningTest mcover.coverage.munit.client.MCoverPrintClient();
			var httpClient = AdaptiveLearningTest HTTPClient(AdaptiveLearningTest mcover.coverage.munit.client.MCoverSummaryReportClient());
		#else
		...
		//runner.addResultClient(AdaptiveLearningTest HTTPClient(AdaptiveLearningTest JUnitReportClient()));
